...
class ODStudentsListWorker{
   ...
   func fetch(user_type:String,dynamic_db:String,onSuccess successCallback:(ODStudentsListresponseHandler)?,onFailure failureCallback: @escaping(ODStudentsListresponseHandler)) {
