...
class TeacherDetailsWorker{
   ...
   func fetch(teacher_id:String,dynamic_db:String, onSuccess successCallback:(TeacherDetailsresponseHandler)?,onFailure failureCallback: @escaping(TeacherDetailsresponseHandler)) {
